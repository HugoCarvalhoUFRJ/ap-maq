...
comparável ou superior ao MQO, especialmente quando $d$ é grande.

O notebook \texttt{Aula prática 02} percorre tudo isso no
\texttt{superconductivity.csv} ($d=81$), inclusive a pegadinha de escala entre
...
\begin{itemize}[leftmargin=1.4cm]
  ...
  \item Em altas dimensões MQO tem variância alta e nem existe se $d>n$.
