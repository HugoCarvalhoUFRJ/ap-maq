...
Vale ver o primeiro mal acontecer. Fixe $n=60$ observações e vá aumentando $p$, com
...
\paragraph{Para praticar.} \texttt{Lista teorica 02.pdf} (teórica, com gabarito) e \texttt{Lista prática 02.ipynb} (prática, para completar as lacunas), nesta mesma pasta.
