...
\begin{itemize}[leftmargin=1.4cm]
  ...
  \item estimar a mesma probabilidade pelo Teorema de Bayes: \textbf{Bayes ingênuo}
...
%==============================================================================
A outra família modela como os dados de cada classe são gerados, e inverte:
...
\begin{itemize}[leftmargin=1.4cm]
  \item Perda 0--1 \eqref{eq:risco01}; o \textbf{classificador de Bayes}
        ...
        desconhecido.
  \item \emph{Plug-in}: estimar $\Prob(Y=c\mid\x)$ e tomar o $\argmax$ --- direto
        (discriminativo) ou pelo Teorema de Bayes \eqref{eq:gen} (generativo).
