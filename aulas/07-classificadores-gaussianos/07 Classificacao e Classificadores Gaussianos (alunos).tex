...
\begin{itemize}[leftmargin=1.4cm]
  ...
  \item ajustar uma \textbf{regressão logística} por máxima verossimilhança e
        reconhecer sua versão penalizada e a multiclasse;
  \item estimar a mesma probabilidade pelo Teorema de Bayes, com o \textbf{Bayes
  ...
  \item contrastar as abordagens \emph{discriminativa} e \emph{generativa}.
\end{itemize}
...
\begin{description}[leftmargin=2.6cm,style=nextline]
  \item[Discriminativos] modelam $\Prob(Y=c\mid\x)$ \emph{diretamente} --- é o caso
        da regressão logística, a próxima seção.
...
%==============================================================================
A outra família não modela $\Prob(Y=c\mid\x)$; modela como os dados de cada classe
são gerados, e inverte:
...
hipérboles. A Figura~\ref{fig:fronteiras} põe as quatro fronteiras lado a lado.
\end{observacao}
...
% sem a quebra, o título abaixo fica sozinho no pé da página, com o listing
% inteiro empurrado para a página seguinte
\newpage
%==============================================================================
...
\begin{itemize}[leftmargin=1.4cm]
  ...
  \item \emph{Plug-in}: estimar $\Prob(Y=c\mid\x)$ e tomar o $\argmax$ --- ou
        diretamente (discriminativo), ou pelo Teorema de Bayes \eqref{eq:gen},
        modelando $f(\x\mid Y=c)$ (generativo).
  ...
  \item Discriminativo (menos suposições, robusto com muito dado) $\times$
        generativo (eficiente sob suposições corretas e com poucos dados).
