...
%==============================================================================
%  Aula 10 --- Máquinas de Vetores de Suporte (SVM) --- SLIDES
%
...
\begin{frame}{Cuidado: o $C$ do slide anterior aparece de duas formas}
    E não é sutileza de notação --- dá para medir. Na Seção 8 da \texttt{Aula prática 10}, ajustando \texttt{SVC} ao \texttt{breast\_cancer} com $\gamma$ e \emph{kernel} fixos:
