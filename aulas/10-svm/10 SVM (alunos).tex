...
\noindent
Mudança de perspectiva em relação à Aula~08. Lá, todo método passava por modelar
...
%==============================================================================
Codifique as classes como $y\in\{-1,+1\}$. Um \textbf{hiperplano} em $\R^d$ é o
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../../recursos/figuras/10-margem.pdf}
...
\begin{equation}\label{eq:dual}
  ...
  \qquad \inner{\x}{\X_k}=\textstyle\sum_{j=1}^d x_j x_{k,j},
\end{equation}
...
interno lá. Com o kernel polinomial de grau $p$ em $\R^d$ o espaço tem dimensão
$\binom{d+p}{p}$, e com o RBF ele é \emph{de dimensão infinita} --- e o custo
continua sendo uma conta com $d$ termos. É esse o negócio.
\end{exemplo}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../../recursos/figuras/10-kernel.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\textwidth]{../../recursos/figuras/10-perdas.pdf}
...
\begin{description}[leftmargin=2.8cm,style=nextline]
  ...
  \item[Um-contra-todos (OvA)] treina $K$ SVMs (cada classe vs.\ o resto) e escolhe
        ...
        desbalanceado --- com a ressalva da Aula~09.
\end{description}
...
\emph{sempre} padronize dentro do \emph{pipeline} (Aula~07). (ii) $C$ e $\gamma$
...
O notebook \texttt{Exemplo - SVM em dados artificiais} ilustra o efeito de $C$,
