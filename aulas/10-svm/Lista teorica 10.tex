...
%  O gabarito sai de "Lista teorica 10 - gabarito.tex".
%==============================================================================
...
\begin{document}
\cabecalholista{10}{Máquinas de Vetores de Suporte (SVM)}
...
\begin{enumerate}[label=(\alph*),leftmargin=1.1cm]
  ...
  \item Em $\R^d$, o espaço de atributos do kernel polinomial de grau $p$ tem
        $\binom{d+p}{p}$ dimensões. Calcule para $d=100$, $p=3$ e para
        $d=1000$, $p=3$.
...
Em $d=2$ e $p=2$ a diferença é pequena; o item (c) mostra o que acontece quando
não é.
...
\]
Com $d=1000$ e grau 3, o espaço de atributos tem \textbf{167 milhões} de
...
$n$, não por $d$ --- a matriz de Gram é $n\times n$, o que explica o custo entre
