...
\begin{emsala}
Continuação direta da Aula~08: lá vimos que o classificador de Bayes minimiza a
...
\end{lstlisting}
O notebook \texttt{Aula prática 09} e o material \texttt{MatConf.pdf} exploram a
