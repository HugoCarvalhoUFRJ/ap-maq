...
\begin{document}
\cabecalholista{09}{Métricas para Classificação}
...
transações perfeitamente e ainda assim classificar **todas** como normais, porque
nenhuma passa do corte.

É por isso que a conduta correta é separar as duas decisões: **primeiro estime
...
\begin{enumerate}[label=(\alph*),leftmargin=1.1cm]
  ...
  \item A Aula~09 relata a medição: naive Bayes e logística praticamente empatam
