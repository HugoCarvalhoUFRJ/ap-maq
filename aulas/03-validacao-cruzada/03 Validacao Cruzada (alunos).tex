...
$0{,}3049$, \emph{menor} que o $0{,}3580$ do grau~5, e risco $25{,}5$. Ao subir o
grau, o viés do modelo desapareceu e o da régua explodiu junto. É por isso que o
erro de treino não pode arbitrar entre modelos de complexidades diferentes: quanto
mais flexível o candidato, mais a régua o favorece.
\end{atencao}
...
contrário do erro de treino, que erra sempre por baixo. (Na tabela da §8 da
\texttt{Aula prática 03} isso se vê em $k=2$, $5$ e $10$; de $k=25$ em diante o
viés já é menor que o ruído da própria simulação, e o sinal deixa de ser legível.)
A segunda é que esse viés
não diz nada sobre a \emph{variância}: aquela depende de quanto as dobras se
parecem, que é a outra metade do argumento clássico --- e é a metade que a medição
abaixo vai contrariar.
\end{ideia}
