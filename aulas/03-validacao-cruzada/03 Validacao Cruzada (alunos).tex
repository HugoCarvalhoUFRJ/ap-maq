...
modelo flexível o bastante \emph{interpola} os dados (erro de treino zero) e
generaliza pessimamente. \textbf{Nunca} selecione modelos nem reporte desempenho
com o erro de treino.
\end{atencao}
...
\paragraph{Para praticar.} \texttt{recursos/listas/Lista de exercícios 03.pdf}.
