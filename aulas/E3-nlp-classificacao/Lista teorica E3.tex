...
\texttt{Pipeline} e à grade de busca da Aula~06, não a uma decisão tomada uma vez
no começo.
...
\begin{itemize}[leftmargin=1.4cm]
  \item é a \textbf{maldição da dimensionalidade} na sua forma mais
        extrema: com $p\approx 8\,700$, a taxa $n^{-2/(2+p)}$ é indistinguível de
...
\begin{itemize}[leftmargin=1.4cm]
  ...
  \item modelos lineares em alta dimensão esparsa toleram bem colunas extras
        ...
        Ritov citada na Aula~02, em que $p$ aparece só dentro de um logaritmo.
\end{itemize}
