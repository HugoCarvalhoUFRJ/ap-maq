...
fração $1-m/d$ deles --- a árvore é obrigada a olhar para outra coisa, e descobre
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{../../recursos/figuras/06-numero-arvores.pdf}
  \caption{A diferença mais prática entre os dois métodos, medida num problema com
  $n=150$, $d=8$ e ruído alto. À esquerda, a floresta: o risco cai, estabiliza em
