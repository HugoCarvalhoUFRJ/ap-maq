...
\begin{document}
\cabecalholista{10}{KNN e Árvores de Classificação}
...
A má notícia está na palavra \emph{assintótico}. A garantia
...
Terceiro, e mais importante na prática: o $k$ ótimo depende de $n$, de $p$ e do
...
dispensam metade do \texttt{Pipeline} da Aula~06.
...
de \emph{regressão} da Aula~05 usa, aplicada à variável indicadora $\1{Y=1}$.
