...
\author{Curso de Aprendizado de Máquina --- UFRJ\\
...
Nadaraya--Watson; regressão polinomial local &
AME §4.1--4.5; ISLP §3.5, 7.1--7.6 \\
...
\begin{itemize}[leftmargin=1.4cm]
  \item \textbf{Aulas práticas} (notebooks): 01, 02, 03--05, 06--07 e 08,
        alinhadas às aulas teóricas correspondentes e guardadas na pasta da
        primeira aula que cada uma cobre (\texttt{01-introducao},
        \texttt{02-regressao-linear}, \texttt{03-validacao-cruzada},
        \texttt{06-arvores-ensembles} e
        \texttt{08-classificadores-gaussianos}). As práticas 01 e 02 seguem a
        conduta dos laboratórios do [ISLP]: texto e código alternados, uma ideia
        por célula, com blocos ``Sua vez'' para exercício em sala.
  \item \textbf{Exemplos} em Python, na pasta da aula correspondente: comparação
        ...
        $k$-médias (E1), PCA (E2) e NLP (E3).
  \item \textbf{Listas de exercícios} 01--08, em \texttt{recursos/listas}, e duas
        \textbf{avaliações presenciais} (AP1 e AP2) com gabarito, em
