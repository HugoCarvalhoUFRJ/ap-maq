...
\begin{enumerate}[label=\textbf{\Roman*.}]
  \item \textbf{Fundamentos e Regressão} (Aulas 01--06): formalização do problema
  ...
  \item \textbf{Classificação} (Aulas 07--10): formulação do problema de
        classificação, classificadores gaussianos, métricas, SVM, KNN e árvores
        de classificação.
...
\noindent Ao todo: \textbf{10 aulas oficiais} $+$ \textbf{3 aulas extras}
$=$ \textbf{13 conjuntos de notas de aula}, mais este documento de planejamento.
...
05 & Árvores de Regressão e \emph{Ensembles} &
Árvores de regressão (construção e poda); agregação e redução de variância;
\emph{bagging}; florestas aleatórias &
AME §4.8--4.10; ISLP cap.~8 \\

06 & Pré-processamento e \emph{Pipelines} &
...
07 & Classificação e Classificadores Gaussianos &
Formulação e função de risco 0--1; classificador de Bayes; classificadores
\emph{plug-in}; Bayes ingênuo; LDA e QDA &
AME §7.1--7.3, §8.1; ISLP §2.2.3, §4.4 \\

08 & Métricas para Classificação &
...
09 & Máquinas de Vetores de Suporte (SVM) &
...
10 & KNN e Árvores de Classificação &
...
\begin{itemize}[leftmargin=1.4cm]
  \item \textbf{Aulas práticas} (notebooks): uma por aula,
        ...
        alternados, uma ideia por célula, mostrando o resultado em vez de
        deixá-lo em aberto --- quem propõe exercício é a lista da mesma aula.
  ...
  \item \textbf{Listas de exercícios}, também uma por aula e na pasta da própria
        ...
        \begin{itemize}
          \item \texttt{Lista teorica NN.tex/.pdf} --- 2 a 4 exercícios de
  ...
  \item \textbf{Exemplos} em Python, na pasta da aula correspondente: comparação
        de classificadores paramétricos (aula 07), SVM (09), KNN e árvores (10),
        $k$-médias (E1) e PCA (E2).
  \item As \textbf{avaliações do curso}, em \texttt{avaliacoes/}, na raiz: a
        \texttt{Lista de revisao 01-06} --- onze exercícios inéditos de nível
        intermediário, cobrindo o Bloco~I --- e a \texttt{Avaliacao teorica 01},
        cujas três questões foram \emph{sorteadas} dessa lista, uma por aula.
        Como nas listas, o gabarito sai do mesmo arquivo-fonte do enunciado.
  \item As duas \textbf{avaliações presenciais} de 2025-02 (AP1 e AP2) com
        gabarito, herdadas, em \texttt{recursos/avaliacoes}.
\end{itemize}
