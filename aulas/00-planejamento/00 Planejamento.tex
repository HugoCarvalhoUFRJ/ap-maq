...
%==============================================================================
As notas de aula são teóricas; o curso conta ainda com material de apoio já
existente na pasta \texttt{materiais-didaticos}, ao qual as notas fazem referência:
\begin{itemize}[leftmargin=1.4cm]
  \item \textbf{Aulas práticas} (notebooks): 01--02, 03--05, 06--07, 08, alinhadas
        às aulas teóricas correspondentes.
  \item \textbf{Exemplos} em Python: SVM, KNN e árvores, comparação de
        classificadores paramétricos, PCA, $k$-médias, NLP.
  \item \textbf{Listas de exercícios} 01--08 e duas \textbf{avaliações presenciais}
        (AP1 e AP2) com gabarito.
\end{itemize}
...
%==============================================================================
\begin{itemize}[leftmargin=1.4cm]
  \item Cada aula tem um arquivo \texttt{NN Título.tex} compilável de forma
        independente (preâmbulo completo).
