...
\begin{emsala}
Use os notebooks \texttt{Aula prática 11}, \texttt{Comparação entre classificadores
paramétricos} e o
...
A §7 da \texttt{Aula prática 11} refaz a tabela numa base de classe rara ($10\%$ de
...
\begin{itemize}[leftmargin=1.2cm,nosep]
  \item a \textbf{acurácia} varia de $0{,}8989$ a $0{,}9072$ entre os sete métodos, e
        ...
        tabela;
  \item com o corte de custo $1{:}20$ da Aula~09 --- $0{,}0476$ --- a árvore podada e
...
--- a resposta é da Aula~09, e é calibrar, não trocar de modelo.
\end{emsala}
