...
Aula~09 para um falso negativo que custa vinte falsos positivos --- $0{,}0476$ ---
...
de usá-la, confira a calibração do modelo (Aula~09) --- ou calibre-o, que é barato.
\end{atencao}
...
\paragraph{Para praticar.} \texttt{Lista teorica 11.pdf} (teórica, com gabarito) e \texttt{Lista prática 11.ipynb} (prática, para completar as lacunas), nesta mesma pasta.
