...
\begin{description}[leftmargin=2.6cm,style=nextline]
  ...
  \item[Redução de dimensão] PCA como etapa do \emph{pipeline} (Aula extra E2),
        também ajustada apenas no treino --- e esta \emph{não} é inofensiva: os
        componentes principais são direções aprendidas de todas as colunas ao mesmo
        tempo, e computá-los fora da dobra é um vazamento da primeira categoria da
        hierarquia acima.
\end{description}
...
O notebook \texttt{Aula prática 06 e 07} monta esse fluxo completo no
