...
Árvores, florestas e \emph{boosting} (Aula~06) comparam valores \emph{dentro} de
...
A terceira é menos óbvia: \textbf{LDA, QDA e Bayes ingênuo} (Aula~08) também são
...
--- a padronização já está embutida na estimativa. A §9 da \texttt{Aula prática 08}
